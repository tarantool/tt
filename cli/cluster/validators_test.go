...
func TestAnyValidator_nil(t *testing.T) {
	...
	assert.EqualError(t, err,
		"failed to validate [\"<nil>\"]: a value expected, got nil")
}
	...
	cases := []struct {
	...
	}{
		{
			...
			"failed to validate [\"<nil>\"]: " +
				"unexpected type <nil>, expected string",
		},
		{
			struct{}{},
			"failed to validate [\"{}\"]: " +
				"unexpected type struct {}, expected string",
		},
	}
...
func TestBooleanValidator_unsupported(t *testing.T) {
	cases := []struct {
		...
		{nil, "failed to validate [\"<nil>\"]: " +
			"unexpected type <nil>, expected boolean"},
		{"foo", "failed to validate [\"foo\"]: " +
			"unexpected type string, expected boolean"},
		{2, "failed to validate [\"2\"]: " +
			"unexpected type int, expected boolean"},
		{1.0, "failed to validate [\"1\"]: " +
			"unexpected type float64, expected boolean"},
	}
...
func TestIntegerValidator_unsupported(t *testing.T) {
	cases := []struct {
		...
		{nil, "failed to validate [\"<nil>\"]: " +
			"unexpected type <nil>, expected integer"},
		{false, "failed to validate [\"false\"]: " +
			"unexpected type bool, expected integer"},
		{"foo", "failed to validate [\"foo\"]: failed to parse integer"},
		{1.0, "failed to validate [\"1\"]: " +
			"unexpected type float64, expected integer"},
	}
...
func TestNumberValidator_unsupported(t *testing.T) {
	cases := []struct {
		...
		{nil, "failed to validate [\"<nil>\"]: unexpected type <nil>, expected number"},
		{false, "failed to validate [\"false\"]: unexpected type bool, expected number"},
		{"foo", "failed to validate [\"foo\"]: failed to parse number"},
	}
...
func TestSequenceValidator_error(t *testing.T) {
	...
	assert.Nil(t, value)
	assert.EqualError(t, err, "failed to validate []: foo1")
}
...
func TestSequenctValidator_number_string(t *testing.T) {
	...
	cases := []struct {
		...
		{nil, nil, "failed to validate [\"<nil>\"]: " +
			"unexpected type <nil>, expected number\n" +
			"unexpected type <nil>, expected string"},
		{struct{}{}, nil, "failed to validate [\"{}\"]: " +
			"unexpected type struct {}, expected number\n" +
			"unexpected type struct {}, expected string"},
		{9, float64(9), ""},
		{"9", float64(9), ""},
		{"1.1", float64(1.1), ""},
...
func TestAllowedValidator_nil_allowed(t *testing.T) {
	...
	assert.Nil(t, value)
	assert.EqualError(t, err, "failed to validate [\"foo\"]: "+
		"should be one of []")
}
...
func TestAllowedValidator_not_exist(t *testing.T) {
	...
	assert.Equal(t, 1, calls)
	assert.Nil(t, value)
	assert.EqualError(t, err, "failed to validate [\"123\"]: "+
		"should be one of [foo bar zoo]")
}
...
func TestRecordValidator_errors(t *testing.T) {
	...
	assert.Nil(t, value)
	assert.ErrorContains(t, err, "failed to validate [\"bar\"]: foo1")
	assert.ErrorContains(t, err, "failed to validate [\"foo\"]: foo2")
}
...
func TestMapValidator_invalid_value(t *testing.T) {
	...
	assert.Nil(t, value)
	assert.EqualError(t, err, "failed to validate [\"zoo\"]: foo1")
}
...
func TestMapValidator_invalid_multiple(t *testing.T) {
	...
	assert.Nil(t, value)
	assert.ErrorContains(t, err, "failed to validate []: foo1")
	assert.ErrorContains(t, err, "failed to validate [\"zoo\"]: foo2")
}
