...
const (
	fmtUnexpected  = "unexpected value %q of type %v, expected %s"
	fmtParseFailed = "failed to parse value %q to type %s"
)
...
func (err ValidateError) Error() string {
	...
	return fmt.Sprintf("invalid path %q: %s",
		strings.Join(err.path, "."), errors.Join(err.errs...))
}
...
func (validator StringValidator) Validate(value any) (any, error) {
	...
	default:
		return nil, wrapValidateErrors([]string{},
			fmt.Errorf(fmtUnexpected,
				fmt.Sprint(value), reflect.TypeOf(value), "string"))
	}
}
...
func (validator BooleanValidator) Validate(value any) (any, error) {
	...
	default:
		return nil, wrapValidateErrors([]string{},
			fmt.Errorf(fmtUnexpected,
				fmt.Sprint(value), reflect.TypeOf(value), "boolean"))
	}
}
...
func (validator IntegerValidator) Validate(value any) (any, error) {
	...
	default:
		return nil, wrapValidateErrors([]string{},
			fmt.Errorf(fmtUnexpected,
				fmt.Sprint(value), reflect.TypeOf(value), "integer"))
	}
}
...
func (validator NumberValidator) Validate(value any) (any, error) {
	...
	case string:
		...
		if err != nil {
			return nil, wrapValidateErrors([]string{},
				fmt.Errorf(fmtParseFailed, fmt.Sprint(value), "number"))
		}
		return fvalue, nil
	case int, int8, int16, int32, int64:
	...
	default:
		return nil, wrapValidateErrors([]string{},
			fmt.Errorf(fmtUnexpected,
				fmt.Sprint(value), reflect.TypeOf(value), "number"))
	}
}
...
func (validator AllowedValidator) Validate(value any) (any, error) {
	...
	if !val.Comparable() {
		return nil, wrapValidateErrors([]string{},
			fmt.Errorf("value %q is not comparable", fmt.Sprint(value)))
	}
	...
	return nil, wrapValidateErrors([]string{},
		fmt.Errorf("value %q should be one of %v", fmt.Sprint(value), validator.allowed))
}
