...
def test_init_basic_functionality(tt_cmd, tmpdir):
    ...
    with open(os.path.join(tmpdir, config_name), 'r') as stream:
        ...
        assert data_loaded["tt"]["app"]["run_dir"] == "my_run_dir"+inst_dir
        assert data_loaded["tt"]["app"]["log_dir"] == "my_log_dir"+inst_dir
        assert data_loaded["tt"]["app"]["wal_dir"] == "my_data_dir"+inst_dir
        assert data_loaded["tt"]["app"]["vinyl_dir"] == "my_data_dir"+inst_dir
        assert data_loaded["tt"]["app"]["memtx_dir"] == "my_data_dir"+inst_dir
...
def test_init_missing_configs(tt_cmd, tmpdir):
    ...
    with open(os.path.join(tmpdir, config_name), 'r') as stream:
        data_loaded = yaml.safe_load(stream)
        assert data_loaded["tt"]["app"]["run_dir"] == "var/run" + inst_dir
        assert data_loaded["tt"]["app"]["log_dir"] == "var/log" + inst_dir
        assert data_loaded["tt"]["app"]["wal_dir"] == "var/lib" + inst_dir
        assert data_loaded["tt"]["app"]["vinyl_dir"] == "var/lib" + inst_dir
        assert data_loaded["tt"]["app"]["memtx_dir"] == "var/lib" + inst_dir
        assert data_loaded["tt"]["app"]["instances_enabled"] == "instances.enabled"
...
def test_init_basic_tarantoolctl_cfg(tt_cmd, tmpdir):
    ...
    with open(os.path.join(tmpdir, config_name), 'r') as stream:
        ...
        assert data_loaded["tt"]["app"]["wal_dir"] == "/opt/wal" + inst_dir
        assert data_loaded["tt"]["app"]["vinyl_dir"] == "/opt/vinyl" + inst_dir
        assert data_loaded["tt"]["app"]["memtx_dir"] == "/opt/snap" + inst_dir
        assert data_loaded["tt"]["app"]["instances_enabled"] == "instances.enabled"
...
def test_tarantoolctl_cfg_from_doc(tt_cmd, tmpdir):
    ...
    with open(os.path.join(tmpdir, config_name), 'r') as stream:
        ...
        assert data_loaded["tt"]["app"]["wal_dir"] == "lib/tarantool" + inst_dir
        assert data_loaded["tt"]["app"]["vinyl_dir"] == "lib/tarantool" + inst_dir
        assert data_loaded["tt"]["app"]["memtx_dir"] == "lib/tarantool" + inst_dir
