    ...
    return [
        ...
        },
        {
            ...
            "check_exist": [
                ...
                os.path.join("tt.yaml"),
                os.path.join("test_app/config.yaml"),
                os.path.join("test_app/instances.yaml"),
                os.path.join("test_app/router.lua"),
                os.path.join("test_app/storage.lua"),
            ],
            "check_not_exist": [
                os.path.join("test_app/test_app-scm-1.rockspec"),
                os.path.join("test_app/tt.yaml"),
                "include",
                "modules",
                "templates",
